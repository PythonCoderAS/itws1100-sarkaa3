...
<?php
  if ($dbOk) {
    ...
    $create_query = 'create table if not exists movie_actors (movieid int unsigned not null, actorid int unsigned not null, PRIMARY KEY(movieid, actorid), FOREIGN KEY (movieid) REFERENCES movies(id), FOREIGN KEY (actorid) REFERENCES actors(actorid));';
    $db->query($create_query);
